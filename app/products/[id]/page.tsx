...
import { Star, Heart, Share2, ChevronRight, Shield, Truck, RotateCcw } from 'lucide-react';
...
export default function ProductDetailPage() {
  ...
  const product = {
    ...
    price: 29000,
    originalPrice: 49000,
    description: '부드러운 코튼 소재로 편안한 착용감을 제공하는 베이직 티셔츠입니다. 깔끔한 핏과 다양한 컬러로 어떤 스타일링에도 잘 어울립니다.',
    images: [
  ...
  const selectedSize = product.sizes.find(size => size.name === selectedVariant.size);
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-center space-x-3">
                <div className="flex items-center border border-gray-300 rounded-lg">
                  ...
                  <button
                    ...
                    className="p-2 hover:bg-gray-50 transition-colors"
                    disabled={!isInStock || quantity >= (selectedSize?.stock || 0)}
                  >
                    +
                  </button>
                </div>
            ...
            <div className="grid grid-cols-3 gap-4 py-6 border-t border-gray-200">
              <div className="text-center">
                ...
                <div className="text-xs text-gray-500">평일 오후 2시까지 주문시</div>
              </div>
              <div className="text-center">
