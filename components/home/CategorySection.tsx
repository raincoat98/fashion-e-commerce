    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div ref={headerRef} className="text-center mb-10 sm:mb-12 lg:mb-16">
          <div className="inline-flex items-center space-x-2 bg-yellow-100 dark:bg-yellow-900/20 text-yellow-800 dark:text-yellow-400 px-4 py-2 rounded-full text-sm font-medium mb-4">
        ...
        >
          {categories.map((category) => (
            <Link key={category.id} href={`/categories/${category.id}`}>
              <div className="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-white dark:bg-gray-800 lumina-shadow-lg hover:lumina-shadow-xl dark:hover:shadow-gray-800/50 transition-all duration-500 cursor-pointer">
                {/* Background Image */}
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              ...
              <Link href="/lookbook" className="flex-1 sm:flex-none">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold transition-all duration-300"
                >
                  룩북 보기
                </Button>
              </Link>
